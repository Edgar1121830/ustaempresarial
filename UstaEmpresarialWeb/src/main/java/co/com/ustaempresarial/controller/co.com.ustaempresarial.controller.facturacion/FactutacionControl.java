...
import co.com.facturacion.modelo.*;
...
import co.com.ustaempresarial.controller.*;
...
public class FactutacionControl implements Serializable{
	...
	public void generarFactura(String nombreDelCliente) {
		ClienteControl control = new ClienteControl();
		Cliente cliente = control.buscarClientePorNombre(nombreDelCliente);
		String Nit="860.012.357-6";
		String NombreDeLaEmpresa="Universidad Santo Tomas";
		String nombreCliente = nombreDelCliente;
		VentaDetalleControl ventadetalle= new VentaDetalleControl();
